 ...
 * @author YOLANDA
 */
public class HttpResponseEListener<T> implements OnResponseListener<T>
{
     ...
     */
    public HttpResponseEListener(Context context, Request<?> request, HttpListener<T> httpCallback, boolean canCancel, boolean isLoading)
    {
